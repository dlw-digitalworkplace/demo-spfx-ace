...
} from '../CardViewAdvancedAdaptiveCardExtension';

// Extend from BaseBasicCardView
export class MediumCardView extends BaseBasicCardView<ICardViewAdvancedAdaptiveCardExtensionProps, ICardViewAdvancedAdaptiveCardExtensionState> {
